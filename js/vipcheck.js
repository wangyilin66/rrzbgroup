...
function auto3(index, obj) {
    return '<tr>' +
        ...
        '<td style="margin: auto;display: block;height: 10px;text-overflow: ellipsis;overflow: hidden;width: 98px;white-space: nowrap;" title="'+obj.relationshipGroup+'">' + obj.relationshipGroup + '</td>' +
        '<td>' + obj.name + '</td>' +
