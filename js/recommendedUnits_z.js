 ...
 daweimingcheng2();       
		...
		function auto4(index, obj) {
			...
			return '<tr>' +
				...
				'<td>' + obj.name + '</td>' +
				'<td>' + msg + '<td>' +
				'<button id="' + 'cnm_up' + obj.id + '"class="layui-btn cnm_up"style="width:50px;height:20px;line-height:20px;padding-left: 10px;margin-top: 0px;" onclick="reup(' + obj.id + ')">上移</button>' +
				'<a><button id="' + 'cnm_down' + obj.id + '"class="layui-btn cnm_down"style="width:50px;height:20px;line-height:20px;padding-left: 10px;margin-top: 0px;"onclick="redown(' + obj.id + ')">下移</button></a>' +
